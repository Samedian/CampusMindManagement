...
namespace CampusMindManagement
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IAdminBAL, AdminBAL>();
            services.AddTransient<IAdminDAL, AdminDAL>();
            services.AddTransient<IUserDAL, UserDAL>();
            services.AddTransient<IConvertModelToEntity, ConvertModelToEntity>();
            services.AddTransient<IAccountBAL, AccountBAL>();
            services.AddTransient<IAccountDAL, AccountDAL>();
            services.AddTransient<IConvertEntityModelDAL, ConvertEntityModelDAL>();
